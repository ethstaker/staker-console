        ...
        {step === "upload" ? (
          <>
            <Typography className="mb-6 text-secondaryText">
              ...
              validators. To learn more about the validator creation process,
              managing validators, and generating the deposit file, please
              review our comprehensive user guide.
            </Typography>
